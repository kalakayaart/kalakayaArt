  ...
  return (
    <section className="w-full max-w-[1240px] mx-auto mt-8 md:mt-16 px-4 md:px-6 flex flex-col md:flex-row gap-8 md:gap-12">
      ...
      <div className="w-full md:w-1/2 flex flex-col space-y-6 md:space-y-12">
        ...
        {/* BODY TEXT */}
        <p className="text-[15px] md:text-[16px] text-black text-left md:text-justify leading-relaxed font-[EB_Garamond,serif] tracking-wide">
        ...
        <div className="space-y-4 md:space-y-12 mt-4 md:mt-12">
          ...
          {/* PURPOSE HEADING */}
          <h3 className="text-[24px] md:text-[32px] font-semibold leading-relaxed font-[Mustica_Pro,sans-serif] text-black">
            Purpose
          </h3>
