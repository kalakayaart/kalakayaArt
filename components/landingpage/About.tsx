  ...
  return (
    <section className="w-full max-w-[1240px] mx-auto mt-8 md:mt-16 px-4 md:px-6 flex flex-col md:flex-row gap-8 md:gap-12">
      ...
      <div className="w-full md:w-1/2 flex flex-col space-y-6 md:space-y-12">
        ...
        {/* MAIN HEADING */}
        <h2 className="text-[26px] md:text-[32px] font-semibold leading-snug font-mustica">
          Explore and celebrate the art and heritage that defines Nepal.
        </h2>

        {/* BODY TEXT */}
        <p className="text-[16px] md:text-[17px] text-left md:text-justify leading-relaxed font-garamond tracking-wide text-gray-800">
        ...
        <div className="space-y-4 md:space-y-12 mt-4 md:mt-12">
          ...
          {/* PURPOSE HEADING */}
          <h3 className="text-[26px] md:text-[32px] font-semibold leading-tight font-mustica">
            Purpose
          </h3>
